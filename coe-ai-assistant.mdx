...
<img className='block dark:hidden' src='/images/coe-ai-assistant-screenshot.png' alt='COE AI Assistant' />
<img className='hidden dark:block' src='/images/coe-ai-assistant-screenshot.png' alt='COE AI Assistant' />
