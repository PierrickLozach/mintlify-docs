  ...
  <Accordion icon='cloud' title='I am a Genesys direct customer or a Genesys partner'>
    ...
    <AccordionGroup>
      ...
      <Accordion icon="cloud" title="Login to your Genesys Cloud organization">
        ...
        <img className='block dark:hidden' src='/images/genesys-org-set.png' alt='Genesys Organization Set' />
        <img className='hidden dark:block' src='/images/genesys-org-set.png' alt='Genesys Organization Set' />
        ...
        <img className='block dark:hidden' src='/images/more-login-options.png' alt='More Login Options' />
        <img className='hidden dark:block' src='/images/more-login-options.png' alt='More Login Options' />
      ...
      <Accordion icon="gear" title="Perform the initial setup">
        ...
        <AccordionGroup>
          ...
          <Accordion icon="puzzle-piece" title="Activate the applications">
          ...
          <Accordion icon="users-gear" title="Assign Roles to Users">
          ...
          <Accordion icon="envelope" title="Invite other users">
            ...
            3. Users will receive an email with an invitation link to the SPC Portal
          </Accordion>
        </AccordionGroup>
      </Accordion>
    </AccordionGroup>
